...
<img width="1026" height="210" alt="Sistemas (5)" src="https://github.com/user-attachments/assets/1bedd07a-62a3-42ac-afeb-26f47c737376" />
...
<img width="831" height="541" alt="DiagramaDataBase" src="https://github.com/user-attachments/assets/2808c1aa-fae5-4bfa-b615-bea7345d3858" />
...
[Script do Banco de Dados](./Docs/script.sql)

### Diagrama De Navegação 

<img width="581" height="441" alt="diagramaNavegação" src="https://github.com/user-attachments/assets/d54fbc6b-8914-4b54-8668-c71cdd074111" />

### Esboço de Layout de algumas Telas (Apenas Design)
<img width="1366" height="698" alt="CriarDenuncia" src="https://github.com/user-attachments/assets/202c7768-702b-4e44-9f08-7e9dff5fd195" />
<img width="1366" height="698" alt="TelaDenunciaRegistrada" src="https://github.com/user-attachments/assets/90d7be81-44ff-40e7-b611-e0683e14bf87" />
<img width="1366" height="698" alt="TelaPerfil" src="https://github.com/user-attachments/assets/e8550125-8411-470d-b778-6113ec0dba4b" />
<img width="1366" height="698" alt="TelaInicial" src="https://github.com/user-attachments/assets/d15fb178-6270-4170-bec8-0533d8c5606f" />
...
### Micro serviço de Denúncia

```
└── 📁 pixshield_backend_denuncias-main
    ├── 📝 README.md
    ├── 📄 index.js
    ├── ⚙️ package-lock.json
    └── ⚙️ package.json
...
```
└── 📁 pixshield_backend_usuario-main
    ├── 📝 README.md
    ├── 📄 index.js
    ├── ⚙️ package-lock.json
    └── ⚙️ package.json
...
### Micro serviço de Chave Pix

```
└── 📁 pixshield_backend_chavepix-main
    ├── 📝 README.md
    ├── 📄 index.js
    ├── ⚙️ package-lock.json
    └── ⚙️ package.json
...
1.  **Clonar os Repositórios:** Clone todos os microserviços e o Front-end:
    ```bash
    ...
    ```
2.  **Configuração do Banco de Dados:** Crie os três bancos de dados no MySQL (`ps_denuncias`, `ps_usuarios`, `ps_chaves`) econtre o [Script do Banco de Dados](./Docs/script.sql). Configure as credenciais de acesso dentro de cada microserviço.
    

3.  **Iniciar Microserviços (Back-end):** Em **três terminais separados**, inicie os serviços.
    * Para o Micro serviço Denúncia (Porta **5000**):
        ```bash
        cd pixshield_backend_denuncias-main
        npm install
        node index.js
        ```
    * ... (Repita para Usuário e Chave Pix).
4.  **Iniciar o Front-end:** Após confirmar que os Back-ends estão rodando, inicie o Front-end (Porta padrão **5173**):
    ```bash
    cd pix-shield
    npm install
    npm run dev
